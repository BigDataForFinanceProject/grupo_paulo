...
for ticker, df in dados.items():
    # Skip calculation if DataFrame is empty to avoid the error
    if df.empty:
        continue
    df['Retorno_Normalizado'] = df['Close'] / df['Close'].iloc[0]  # Accessing element at index 0 for division
...
<div style="display: flex; justify-content: center;">
  <img src="index3_files/figure-revealjs/coloredlines.png" style="width: 100%; max-width: 1000px;" />
</div>
